...
const generateAutoCard = (brand, color, year) => {
    ...
    <div class="autoCard">
        ...
        <p>Автомобиль ${brand.toUpperCase()} — ${year} года. Возраст авто - ${curYear.getFullYear() - year} лет.</p>
...
// <div class="autoCard">
//   <h2>BRAND — YEAR</h2>
//   <p>Автомобиль BRAND YEAR года. Данное авто было выпущено YEARS назад.</p>
// </div>
